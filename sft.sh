hostfile=""
HF_DATASETS_CACHE="./tmp" WANDB_MODE=disabled HF_ENDPOINT=https://hf-mirror.com deepspeed --include localhost:4,7 --master_port 21269 run_sft.py \
  --data_dir data \
  --do_train \
